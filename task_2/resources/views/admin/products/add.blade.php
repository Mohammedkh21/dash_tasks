                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.products.add_new') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="" id="title" class="form-control" placeholder="title " name="title">
                                                            @error('title')
                                                            <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" value="" id="quantity" class="form-control" placeholder="quantity" name="quantity">
                                                            @error('quantity')
                                                            <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                        </div>
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    @foreach($currencies as $currencie)
                                                                        <option value="{{ $currencie->id }}" >{{ $currencie->cc }}</option>
                                                                    @endforeach

                                                                </ul>
                                                                </select >
                                                                <input name="price" type="number" class="form-control" aria-label="Text input with dropdown button">
                                                            </div>
                                                            @error('currencie_id')
                                                            <small class="text-danger">{{ $message }}</small>
                                                            @enderror
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="status" id="switcheryColor4" class="switchery" data-color="success" checked="" data-switchery="true" >
