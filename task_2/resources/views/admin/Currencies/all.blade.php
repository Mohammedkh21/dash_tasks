                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                    ...
                                    @foreach($Currencies as $Currencie)
                                        <tr class="odd "  >
                                            ...
                                            <td>
                                                <div   class="form-check form-switch" style=" text-align: center;font-size: 22px;" >
                                                    <input Currencie_id="{{ $Currencie->id }}"  @if($Currencie->status ) checked @endif class="form-check-input checkbox-ajax" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
