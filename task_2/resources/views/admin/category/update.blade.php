                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ $category->name }}" id="name" class="form-control" placeholder="name" name="name">
                                                            @error('name')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" @if($category->status) checked @endif value="1"  name="status" id="switcheryColor4" class="switchery" data-color="success"  data-switchery="true" >
