...
@section('content')
    ...
    @if($errors->any())
        <div class="alert  alert-danger ualart" style="display: none; " role="alert">{{ $errors->first() }}</div>
        <script>
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                ...
                                @foreach($products as $product)
                                    <tr class="odd product{{ $product ->id }}"  >
                                        ...
                                        <td>{{ $product->price }}</td>
                                        @if($product->image)
                                            <td><img src="{{ asset('storage/images/'.$product->photo) }}" width="50px" height="50px"  > </td>
                                        @else
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('seller.updateProducts',['id'=>$product->id]) }}"
...
@section('ajax')
    <script>
        ...
        $(document).on('click', '.delete_product', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('seller.deleteProduct') }}",
